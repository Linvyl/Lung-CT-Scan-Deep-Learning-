...
lung_contours, _ = cv2.findContours(opened, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
...
# Dilate mặt nạ phổi
lung_mask = cv2.dilate(opened, cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (10,10)))
...
cv2.imshow('Dilated Mask', lung_mask)
cv2.waitKey(0)
