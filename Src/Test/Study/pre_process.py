...
# Dilate mặt nạ phổi
lung_mask = cv2.dilate(lung_mask, cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (20,20)))

# Hiển thị kết quả
cv2.drawContours(img, [lung_hull], 0, (0,255,0), 2)
cv2.imshow('Lung mask with convex hull and dilation', img)
cv2.waitKey(0)
